...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n  ╷\n3 │ @import \"~bootstrap/scss/application.scss\";\n  │         ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  ╵\n  app/javascript/stylesheets/application.scss 3:9  root stylesheet");
...
/******/ });
//# sourceMappingURL=application-92a719551a35eefae1bc.js.map